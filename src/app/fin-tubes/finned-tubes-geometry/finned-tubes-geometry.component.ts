...
@Component({
  selector: 'app-finned-tubes-geometry',
  templateUrl: './finned-tubes-geometry.component.html',
  styleUrls: ['./finned-tubes-geometry.component.css']
})
export class FinnedTubesGeometryComponent implements OnInit {

  title = 'Finned Tube : Geometry - Fin Tube | Tube Tech Copper & Alloys';
