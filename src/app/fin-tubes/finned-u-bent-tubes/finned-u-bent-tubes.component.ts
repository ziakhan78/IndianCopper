...
@Component({
  selector: 'app-finned-u-bent-tubes',
  templateUrl: './finned-u-bent-tubes.component.html',
  styleUrls: ['./finned-u-bent-tubes.component.css']
})
export class FinnedUBentTubesComponent implements OnInit {

  title = 'Finned U – Bent Tubes - Fin Tubes | Tube Tech Copper & Alloys';
