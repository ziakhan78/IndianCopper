...
@Component({
  selector: 'app-finned-cooling-coils',
  templateUrl: './finned-cooling-coils.component.html',
  styleUrls: ['./finned-cooling-coils.component.css']
})
export class FinnedCoolingCoilsComponent implements OnInit {

  title = 'Finned Cooling Coils - Fin Tubes | Tube Tech Copper & Alloys';
