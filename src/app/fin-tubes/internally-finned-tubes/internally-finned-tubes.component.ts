...
@Component({
  selector: 'app-internally-finned-tubes',
  templateUrl: './internally-finned-tubes.component.html',
  styleUrls: ['./internally-finned-tubes.component.css']
})
export class InternallyFinnedTubesComponent implements OnInit {

  title = 'Internally Finned Tubes - Fin Tube | Tube Tech Copper & Alloys';
