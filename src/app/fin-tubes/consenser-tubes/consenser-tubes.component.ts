...
@Component({
  selector: 'app-consenser-tubes',
  templateUrl: './consenser-tubes.component.html',
  styleUrls: ['./consenser-tubes.component.css']
})
export class ConsenserTubesComponent implements OnInit {
