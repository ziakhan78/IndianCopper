...
@Component({
  selector: 'app-bimetallic-fintubes',
  templateUrl: './bimetallic-fintubes.component.html',
  styleUrls: ['./bimetallic-fintubes.component.css']
})
export class BimetallicFintubesComponent implements OnInit {
