...
@Component({
  selector: 'app-forged-flanges-geometry',
  templateUrl: './forged-flanges-geometry.component.html',
  styleUrls: ['./forged-flanges-geometry.component.css']
})
export class ForgedFlangesGeometryComponent implements OnInit {

  title = 'Forged Flanges : Geometry - Forged Flanges - Bending & Fabrication | Tube Tech Copper & Alloys';
