...
@Component({
  selector: 'app-composite-flanges',
  templateUrl: './composite-flanges.component.html',
  styleUrls: ['./composite-flanges.component.css']
})
export class CompositeFlangesComponent implements OnInit {
