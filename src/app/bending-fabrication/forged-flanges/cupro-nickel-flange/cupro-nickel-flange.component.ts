...
@Component({
  selector: 'app-cupro-nickel-flange',
  templateUrl: './cupro-nickel-flange.component.html',
  styleUrls: ['./cupro-nickel-flange.component.css']
})
export class CuproNickelFlangeComponent implements OnInit {

  title = 'Cupro Nickel Flanges - Forged Flanges - Bending & Fabrication | Tube Tech Copper & Alloys';
