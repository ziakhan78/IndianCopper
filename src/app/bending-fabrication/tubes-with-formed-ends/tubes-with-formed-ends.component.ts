...
@Component({
  selector: 'app-tubes-with-formed-ends',
  templateUrl: './tubes-with-formed-ends.component.html',
  styleUrls: ['./tubes-with-formed-ends.component.css']
})
export class TubesWithFormedEndsComponent implements OnInit {

  title = 'Tubes with Formed Ends - Bending & Fabrication - Tube Tech Copper & Alloys';
