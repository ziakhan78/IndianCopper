...
@Component({
  selector: 'app-cupro-nickel-tubes',
  templateUrl: './cupro-nickel-tubes.component.html',
  styleUrls: ['./cupro-nickel-tubes.component.css']
})
export class CuproNickelTubesComponent implements OnInit {

  title = 'Cupro Nickel Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
