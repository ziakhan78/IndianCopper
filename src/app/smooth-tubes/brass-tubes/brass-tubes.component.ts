...
@Component({
  selector: 'app-brass-tubes',
  templateUrl: './brass-tubes.component.html',
  styleUrls: ['./brass-tubes.component.css']
})
export class BrassTubesComponent implements OnInit {

  title = 'Brass Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
