...
@Component({
  selector: 'app-admiralty-brass-tubes',
  templateUrl: './admiralty-brass-tubes.component.html',
  styleUrls: ['./admiralty-brass-tubes.component.css']
})
export class AdmiraltyBrassTubesComponent implements OnInit {

  title = 'Admiralty Brass Tubes - Brass Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
