...
@Component({
  selector: 'app-aluminum-brass-tubes',
  templateUrl: './aluminum-brass-tubes.component.html',
  styleUrls: ['./aluminum-brass-tubes.component.css']
})
export class AluminumBrassTubesComponent implements OnInit {

 
  title = 'Aluminum Brass Tubes - Brass Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
