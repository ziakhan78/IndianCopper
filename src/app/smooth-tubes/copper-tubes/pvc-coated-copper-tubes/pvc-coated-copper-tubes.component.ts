...
@Component({
  selector: 'app-pvc-coated-copper-tubes',
  templateUrl: './pvc-coated-copper-tubes.component.html',
  styleUrls: ['./pvc-coated-copper-tubes.component.css']
})
export class PvcCoatedCopperTubesComponent implements OnInit {

  title = 'PVC Coated Copper Tubes - Copper Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
