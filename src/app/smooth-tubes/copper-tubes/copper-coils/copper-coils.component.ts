...
@Component({
  selector: 'app-copper-coils',
  templateUrl: './copper-coils.component.html',
  styleUrls: ['./copper-coils.component.css']
})
export class CopperCoilsComponent implements OnInit {

  title = 'Copper Coils - Copper Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
