...
@Component({
  selector: 'app-special-profile-tubes',
  templateUrl: './special-profile-tubes.component.html',
  styleUrls: ['./special-profile-tubes.component.css']
})
export class SpecialProfileTubesComponent implements OnInit {

  title = 'Special Profile Tubes - Square Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
