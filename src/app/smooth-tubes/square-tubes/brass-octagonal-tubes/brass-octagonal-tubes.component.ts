...
@Component({
  selector: 'app-brass-octagonal-tubes',
  templateUrl: './brass-octagonal-tubes.component.html',
  styleUrls: ['./brass-octagonal-tubes.component.css']
})
export class BrassOctagonalTubesComponent implements OnInit {

  title = 'Hexagonal Tubes - Square Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
