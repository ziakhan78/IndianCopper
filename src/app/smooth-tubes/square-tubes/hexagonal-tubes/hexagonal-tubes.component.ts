...
@Component({
  selector: 'app-hexagonal-tubes',
  templateUrl: './hexagonal-tubes.component.html',
  styleUrls: ['./hexagonal-tubes.component.css']
})
export class HexagonalTubesComponent implements OnInit {
