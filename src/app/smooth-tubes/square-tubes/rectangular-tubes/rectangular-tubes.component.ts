...
@Component({
  selector: 'app-rectangular-tubes',
  templateUrl: './rectangular-tubes.component.html',
  styleUrls: ['./rectangular-tubes.component.css']
})
export class RectangularTubesComponent implements OnInit {

  title = 'Rectangular Tubes - Square Tubes - Smooth Tubes | Tube Tech Copper & Alloys';
